...
public class HashFunction {
	...
	HashFunction(int size) {
		arraySize = size;
		theArray = new String[size]; // created an array of size 
		Arrays.fill(theArray, "-1"); //  empty array
	}
	...
	public static void main(String[] args) {
		...
		String[] elementsToAdd = { "1", "5", "17", "21", "26" }; // String array to be added to the Hash Table
	...
	public void hashFunction1(String[] stringsForArray, String[] theArray) {
		for (int n = 0; n < stringsForArray.length; n++) {
			...
			theArray[Integer.parseInt(newElementVal)] = newElementVal; // string value stored at the same index value. 
		}
	}
