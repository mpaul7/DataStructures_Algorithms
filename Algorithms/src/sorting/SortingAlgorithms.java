...
//website : http://www.java2novice.com/java-sorting-algorithms/
...
public class SortingAlgorithms {
	...
	//the elementary sorts.
	//had a group sorted at
	//only partially sorted
	//normally the best of
	//Unlike the other sorts that
	//any given time, groups are here.
